export const Bollywood = [
    {
        ...
        backgroundB : ("images/mangal.jpg")
    },
    {
        headerB : "Catch waves with an adventure guide",
        descriptionB: "Gujarat is vastly underrated and its a mystery to us why the region isnt more well known as a tourist destination.",
        backgroundB : ("images/Hrithik.webp")
    },
    {
        headerB : "Catch waves with an adventure guide",
        descriptionB: "Gujarat is vastly underrated and its a mystery to us why the region isnt more well known as a tourist destination.",
        backgroundB : ("images/salman.jpg")
    },
    {
        headerB : "Catch waves with an adventure guide",
        descriptionB: "Gujarat is vastly underrated and its a mystery to us why the region isnt more well known as a tourist destination.",
        backgroundB : ("images/akshay.jpg")
    },
    {
        headerB : "Catch waves with an adventure guide",
        descriptionB: "Gujarat is vastly underrated and its a mystery to us why the region isnt more well known as a tourist destination.",
        backgroundB : ("images/Bwimages.jpg")
    },
    {
        headerB : "Catch waves with an adventure guide",
        descriptionB: "Gujarat is vastly underrated and its a mystery to us why the region isnt more well known as a tourist destination.",
